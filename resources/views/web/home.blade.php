...
<section class="packages" id="packages">
    ...
    <div class="box-container">
        <div class="box">
            ...
            <div class="content">
                <h3> <i class="fas fa-map-marker-alt"></i> Ho Chi Minh </h3>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3> <i class="fas fa-map-marker-alt"></i> ha noi </h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis, nam!</p>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3> <i class="fas fa-map-marker-alt"></i> Da Lat </h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis, nam!</p>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3> <i class="fas fa-map-marker-alt"></i> Lao Cai </h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis, nam!</p>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3> <i class="fas fa-map-marker-alt"></i> Phu Quoc </h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis, nam!</p>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
